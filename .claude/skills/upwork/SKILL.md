...
- `/Users/albertbakhoj/.claude/skills/upwork/patterns.md` — full copywriting pattern library and power-word lists
- `/Users/albertbakhoj/.claude/skills/upwork/examples.md` — annotated examples from the three reference profiles (Vepa D., Abayomi O., Harsumeet S.)
